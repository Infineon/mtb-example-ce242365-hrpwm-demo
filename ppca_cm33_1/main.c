...
* File Name:   main.c
*
* Description: This is the source code for PPCA Core 1 (CM33_1) in the
...
********************************************************************************
* Summary:
* This is the main function for PPCA Core 1 (CM33_1). This core is initialized
...
int main(void)
{
     ...
     /* Idle loop - PPCA Core 1 is available for future task extensions */
     for(;;)
     {
